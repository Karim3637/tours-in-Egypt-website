...
.back-button:hover {
  ...
  locationIcon.alt = 'Location Icon';
  const locationText = document.createElement('p');
  locationText.textContent = ' sharm elsheikh';
  locationInfo.appendChild(locationIcon);
  locationInfo.appendChild(locationText);
...
function displayDestinationsOverview() {
  ...
  const destinations = [
      ...
      },
      {
          ...
          image: 'imagess/sharmfinal.jpeg' // Replace with actual image path or URL
      },
      {
      ...
      },
      {
          ...
          image: 'imagess/mountsainai.jpg' // Replace with actual image path or URL
      },
      {
          name: 'Siwa Oasis',
